...
export const PlaylistList = () => {
  return (
    <div className="existing-playlist"><ul className="playlist-list"><li><button className="single-playlist-add">Create New Playlist + </button></li><li><button className="single-playlist-add">Playlist 1 </button> </li><li><button className="single-playlist-add">Playlist 2 </button></li><li><button className="single-playlist-add">Playlist 3</button></li></ul></div>
  )
}
export const SingleSong = () => {
  ...
  return (<>
  <div className="single-song">{songData.title && <h1>{songData.title}</h1>}
  <button className="add-to-playlist" onClick={() => {setVisible(prev => !prev)}}>Add To Playlist</button>
